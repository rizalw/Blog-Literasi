...
<body style="background-color:#b6e1fc">
    ...
    <nav class="navbar navbar-expand-lg navbar-light"  style="background-color:#6cc3f9" id="navbar">
        <img src="http:\\localhost:81\ciblog\media\foto.gif" alt="Lambang 23" width="50px" height="50px">
        <a href="#" class="navbar-brand ml-3">SMA Negeri 23 Bandung</a>
    ...
    <div>
        <div class="container" style="background-color:#9dd7fb">
            <div class="row">
                <div class="col-md-4 col-sm-12" style="border: #87cefa solid 1px;">
                    <img src="http:\\localhost:81\ciblog\media\junkfood.jpg" alt="Foto Artikel" width="320px" height="180px" style="margin:1em 0 1em 0">
                </div>
                <div class="col-md-8 col-sm-12" style="border: #87cefa solid 1px; border-left:0px;">
                    <h3><a href="#" style="text-decoration:none; color:black;">Dampak Buruk Junk Food Untuk Kesehatan Tubuh</a></h3>
                    <p><div class="lead">Junk Food disebut makanan instan atau makanan cepat saji yang kini telah berkembang pesat di persaingan perusahaan makanan di Indonesia.</div>Makanan cepat saji dinilai sebagian orang lebih efektif terhadap waktu dan mudah ditemukan. Tak hanya itu saja, makanan cepat saji juga memiliki cita rasa yang lezat ditambah lagi harganya yang terjangkau. <a href="#"class="text-muted">See more...</a></p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-12" style="border: #87cefa solid 1px;">
                    <img src="http:\\localhost:81\ciblog\media\pendidikan.jpg" alt="Foto Artikel" width="320px" height="180px">
                </div>
                <div class="col-md-8 col-sm-12" style="border: #87cefa solid 1px; border-left:0px;">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12" style="border: #87cefa solid 1px;">
                    <img src="http:\\localhost:81\ciblog\media\madu.jpg" alt="Foto Artikel" width="320px" height="180px">
                </div>
                <div class="col-md-8 col-sm-12" style="border: #87cefa solid 1px; border-left:0px;">
